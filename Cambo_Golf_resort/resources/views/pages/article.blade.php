            ...
            <div class="col-sm-12">
                ...
                <div class="ber_link text-center">
                    ...
                    <p> <i class="fa fa-angle-double-right"></i> <a href="{{ route('home') }}">Home</a> / <a
                            href="blogarticle.html">News Article </a> <i class="fa fa-angle-double-left"></i> </p>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <div class="blog_link_area">
                    ...
                    <h3><a href="blogarticle.html">Many web sites still in their infancy</a></h3>
                ...
                <p> Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                    ...
                    will uncover many web sites still in their infancy.Lorem Ipsum is that it has a more-or-less normal
                    distribution of letters, as opposed to using 'Content here, content here', making it look like
                    readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                    default model text, and a search for 'lorem ipsum' will uncover many web sites still in their
                    infancy.Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to
                    using 'Content here, content here', making it look like readable English. Many desktop publishing
                    packages and web page editors now use Lorem Ipsum as their default model text, and a search for
                    'lorem ipsum' will uncover many web sites still in their infancy.Lorem Ipsum is that it has a
                    more-or-less normal distribution of letters, as opposed to using 'Content here,will uncover many web
                    sites still in their infancy.Lorem Ipsum is that it has a more-or-less normal distribution of
                    letters, as opposed to using 'Content here, content here', making it look like readable English.
                    Many desktop publishing lorem ipsum' will uncover many web sites still in their infancy. Lorem Ipsum
                ...
                <p> Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                    ...
                    distribution of letters, as opposed to using 'Content here, content here', making it look like
                    readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                    default model text,Lorem Ipsum is that it has a more-or-less and a search for 'lorem ipsum' will
                    uncover many web sites still in their infancy.Lorem Ipsum is that it has a more-or-less normal
                    distribution of letters, as opposed to using 'Content here, content here', making it look like
                    readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their
                    default model text, and a search for 'lorem ipsum' will uncover many web sites still in their
                    infancy.</p>
