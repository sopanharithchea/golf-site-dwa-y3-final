            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="width:300px;">
                     <a href="{{route('categoryBackControl.show',$row->id)}}" class="btn btn-sm btn-primary" >View </a>
                    ...
                    <a href="" aria-hidden="true" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="{{$row->id}}" data-title="{{$row->category}}">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tfoot>
              ...
              <div class="modal-content">
                ...
                <form action="" method="POST" id="updateForm" autocomplete="off" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                            ...
                            <div class="custom-file">
                                <input type="file" name="category_img" value="" class="custom-file-input" id="category_img" lang="es">
